 ...
 * generated in the com.tmp.services.hello package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://www.tmp.com/services/hello", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://www.tmp.com/services/hello", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.tmp.services.hello
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.tmp.com/services/hello", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.tmp.com/services/hello", name = "queryWeatherResponse")
