 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceService", targetNamespace = "http://www.tmp.com/services/hello", wsdlLocation = "http://localhost:8999/services/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICESERVICE_QNAME = new QName("http://www.tmp.com/services/hello", "WeatherServiceService");
    ...
    public HelloWS getHelloWSPort() {
        return super.getPort(new QName("http://www.tmp.com/services/hello", "HelloWSPort"), HelloWS.class);
    }
    ...
    public HelloWS getHelloWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.tmp.com/services/hello", "HelloWSPort"), HelloWS.class, features);
    }
