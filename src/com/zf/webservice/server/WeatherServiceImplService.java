 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://server.webservice.zf.com/", wsdlLocation = "http://127.0.0.1:8000/weathersearch?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICEIMPLSERVICE_QNAME = new QName("http://server.webservice.zf.com/", "WeatherServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8000/weathersearch?wsdl");
    ...
    public WeatherServiceImpl getWeatherServiceImplPort() {
        return super.getPort(new QName("http://server.webservice.zf.com/", "WeatherServiceImplPort"), WeatherServiceImpl.class);
    }
    ...
    public WeatherServiceImpl getWeatherServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.webservice.zf.com/", "WeatherServiceImplPort"), WeatherServiceImpl.class, features);
    }
