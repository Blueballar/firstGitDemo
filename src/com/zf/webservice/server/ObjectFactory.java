...
package com.zf.webservice.server;
 ...
 * generated in the com.zf.webservice.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://server.webservice.zf.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://server.webservice.zf.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zf.webservice.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.webservice.zf.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.webservice.zf.com/", name = "queryWeather")
